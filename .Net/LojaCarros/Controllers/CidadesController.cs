...
namespace LojaCarros.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public CidadesController(Banco context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CidadeId,Nome,AnoFundacao")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CidadeId,Nome,AnoFundacao")] Cidade cidade)
        {
